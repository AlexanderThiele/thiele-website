...
- **Context Management:** ALWAYS activate the `context-learning-protocol` skill at the start of any interaction. Follow its workflow strictly to capture preferences, and learnings in the `/context/` directory.
