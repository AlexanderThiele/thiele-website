...
description: How to speed up the flutter Bitbucket build pipelines by caching libraries and build files.
date: 2022-09-19
...
Read [how to setup bitbucket pipelines for flutter](https://thiele.dev/blog/flutter-ci-cd-pipeline-on-bitbucket/) if you just want to get started.

## How Dart/Flutter saves dependencies
Whenever you run `flutter pub get`, the system downloads all dependencies to the folder `.pub-cache` in your home directory. 
